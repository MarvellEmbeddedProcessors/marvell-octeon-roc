...
enum roc_npc_sec_ipsec_qsel {
	...
	ROC_NPC_SEC_IPSEC_QSEL_INNER_DSCP_MAP0 = 4,
	ROC_NPC_SEC_IPSEC_QSEL_OUTER_DSCP_MAP0 = 5,
	ROC_NPC_SEC_IPSEC_QSEL_INNER_DSCP_MAP1 = 6,
	ROC_NPC_SEC_IPSEC_QSEL_OUTER_DSCP_MAP1 = 7,
};
