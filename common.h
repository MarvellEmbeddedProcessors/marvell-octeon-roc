...
typedef uint32_t oct_log_class_t;
...
typedef enum
{
  OCT_LOG_LEVEL_UNKNOWN = 0,
#define _(uc,lc) OCT_LOG_LEVEL_##uc,
  foreach_log_level
#undef _
    OCT_LOG_N_LEVELS,
} oct_log_level_t;
...
struct oct_spinlock_s
{
  uint32_t lock;
};

typedef struct oct_spinlock_s *oct_spinlock_t;
...
#define plt_lcore_id()	       g_param.oct_get_thread_index()
...
#define plt_spinlock_t	       oct_spinlock_t
#define plt_spinlock_init      g_param.oct_spinlock_init
#define plt_spinlock_lock      g_param.oct_spinlock_lock
#define plt_spinlock_unlock    g_param.oct_spinlock_unlock
#define plt_spinlock_trylock   g_param.oct_spinlock_trylock
...
#define oct_plt_err(fmt, args...)                                            \
  g_param.oct_log (OCT_LOG_LEVEL_ERR, oct_logtype_base, "%s():%u " fmt "\n",       \
	    __func__, __LINE__, ##args)

#define oct_plt_info(fmt, args...)                                           \
  g_param.oct_log (OCT_LOG_LEVEL_INFO, oct_logtype_base, fmt "\n", ##args)

#define oct_plt_warn(fmt, args...)                                           \
  g_param.oct_log (OCT_LOG_LEVEL_WARNING, oct_logtype_base, fmt "\n", ##args)

#define oct_plt_print(fmt, args...)                                          \
  g_param.oct_log (OCT_LOG_LEVEL_INFO, oct_logtype_base, fmt "\n", ##args)

#define oct_plt_print_no_nl(fmt, args...)                                    \
  g_param.oct_log (OCT_LOG_LEVEL_INFO, oct_logtype_base, fmt, ##args)

#define oct_plt_dbg(subsystem, fmt, args...)                                 \
  g_param.oct_log (OCT_LOG_LEVEL_DEBUG, oct_logtype_##subsystem,                   \
...
extern oct_log_class_t oct_logtype_base;
extern oct_log_class_t oct_logtype_cpt;
extern oct_log_class_t oct_logtype_mbox;
extern oct_log_class_t oct_logtype_npa;
extern oct_log_class_t oct_logtype_nix;
extern oct_log_class_t oct_logtype_sso;
extern oct_log_class_t oct_logtype_npc;
extern oct_log_class_t oct_logtype_tm;
extern oct_log_class_t oct_logtype_tim;
extern oct_log_class_t oct_logtype_pci;
extern oct_log_class_t oct_logtype_ep;
extern oct_log_class_t oct_logtype_bphy;
extern oct_log_class_t oct_logtype_iomem;
extern oct_log_class_t oct_logtype_ml;
...
typedef oct_log_class_t (*oct_log_reg_class_fn_t) (char *class, char *subclass);
typedef void (*oct_log_fn_t) (oct_log_level_t level, oct_log_class_t class, char *fmt, ...);
typedef void (*oct_warning_fn_t) (char *fmt, ...);
...
typedef void (*oct_spinlock_init_fn_t) (oct_spinlock_t * p);
typedef void (*oct_spinlock_lock_fn_t) (oct_spinlock_t * p);
typedef void (*oct_spinlock_unlock_fn_t) (oct_spinlock_t * p);
typedef int (*oct_spinlock_trylock_fn_t) (oct_spinlock_t * p);
typedef uint64_t (*oct_get_thread_index_fn_t)(void);

typedef struct oct_plt_init_param 
{
  oct_log_reg_class_fn_t log_reg_class;
  oct_log_fn_t oct_log;
  ...
  oct_spinlock_init_fn_t oct_spinlock_init;
  oct_spinlock_lock_fn_t oct_spinlock_lock;
  oct_spinlock_unlock_fn_t oct_spinlock_unlock;
  oct_spinlock_trylock_fn_t oct_spinlock_trylock;
  oct_get_thread_index_fn_t oct_get_thread_index;
